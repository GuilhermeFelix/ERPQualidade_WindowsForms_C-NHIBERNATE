...
{
    public class RepositoryConnectDAOCapabilidade_desvios<T> : IConnectDAO<T> where T : class
    {
        public void Alterar(T entidade)
        {

            using (ISession session = Capabilidade_desvios_SessionFactory.AbrirSession())
            {
