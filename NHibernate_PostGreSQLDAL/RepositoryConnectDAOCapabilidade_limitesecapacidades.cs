...
{
    public class RepositoryConnectDAOCapabilidade_limitesecapacidades<T> : IConnectDAO<T> where T : class
    {
        public void Alterar(T entidade)
        {

            using (ISession session = Capabilidade_limitesecapacidades_SessionFactory.AbrirSession())
            {
