...
{
    class Capabilidade_configuracoesdiretoriosestudos_SessionFactory
    {
       ...
       //Usar para armazenamento no Servidor do UolHost a linha abaixo
        ...
        public static ISessionFactory CriarSession()
        {
            if (session != null)
                ...
                var configMap = Fluently.Configure().Database(configDB).Mappings(f => f.FluentMappings.AddFromAssemblyOf<Mapping.Capabilidade_configuracoesdiretoriosestudosMap>());
