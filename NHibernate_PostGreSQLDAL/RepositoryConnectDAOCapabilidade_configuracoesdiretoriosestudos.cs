...
{
    public class RepositoryConnectDAOCapabilidade_configuracoesdiretoriosestudos<T> : IConnectDAO<T> where T : class
    {
        public void Alterar(T entidade)
        {

            using (ISession session = Capabilidade_configuracoesdiretoriosestudos_SessionFactory.AbrirSession())
            {
