...
{
    public class RepositoryConnectDAOCapabilidade_performance<T> : IConnectDAO<T> where T : class
    {
        public void Alterar(T entidade)
        {

            using (ISession session = Capabilidade_performance_SessionFactory.AbrirSession())
            {
