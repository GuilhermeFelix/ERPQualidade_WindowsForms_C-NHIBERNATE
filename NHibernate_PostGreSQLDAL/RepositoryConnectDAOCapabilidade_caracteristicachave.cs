...
{
    public class RepositoryConnectDAOCapabilidade_caracteristicachave<T> : IConnectDAO<T> where T : class
    {
        public void Alterar(T entidade)
        {

            using (ISession session = Capabilidade_caracteristicachave_SessionFactory.AbrirSession())
            {
