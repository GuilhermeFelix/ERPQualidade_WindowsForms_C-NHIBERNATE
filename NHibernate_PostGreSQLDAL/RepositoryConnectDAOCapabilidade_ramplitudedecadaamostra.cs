...
{
    public class RepositoryConnectDAOCapabilidade_ramplitudedecadaamostra<T> : IConnectDAO<T> where T : class
    {
        public void Alterar(T entidade)
        {

            using (ISession session = Capabilidade_ramplitudedecadaamostra_SessionFactory.AbrirSession())
            {
